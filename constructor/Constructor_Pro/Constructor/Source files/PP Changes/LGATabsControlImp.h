...
// ===========================================================================
//	LGATabsControlImp.h			PowerPlant 2.1.1	©1996-1999 Metrowerks Inc.
// ===========================================================================
...
// CONSTRUCTOR CHANGE BEGIN	
	virtual	bool					ApplyForeAndBackColors () const;					// Override
...
// CONSTRUCTOR CHANGE END
	...
	virtual void					DrawWhole	();			// CONSTRUCTOR CHANGE ADDED
