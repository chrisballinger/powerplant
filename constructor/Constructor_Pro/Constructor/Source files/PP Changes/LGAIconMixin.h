...
#include <LGAIconSuiteMixin.h>		// PP CHANGE ADDED

#if 0		// PP CHANGE BEGIN: Duplicate defs in LGAIconSuiteMixin.h
...
public:
	...
	virtual	ResIDT			GetIconResourceID			() const
																{ return mIconSuiteID; }
	virtual	SInt16				GetIconTransform			() const
																{ return mTransform; }
	...
	virtual	SInt16				GetEdgeOffset				() const
																{ return mEdgeOffset; }
