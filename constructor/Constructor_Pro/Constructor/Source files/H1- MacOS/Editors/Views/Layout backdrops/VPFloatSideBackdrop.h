...
// ===========================================================================
//	VPFloatSideBackdrop.h		© 1996-97 Metrowerks Inc. All rights reserved.
// ===========================================================================
//
//   Created: 11/18/96
//     $Date: 2006/01/18 01:34:03 $
//  $History: VPFloatSideBackdrop.h $
//	
//	*****************  Version 4  *****************
...
// ===========================================================================
//
//	VPFloatSideBackdrop draws a simulation of the standard floating
//	window WDEF (with title bar on side).
//
// ===========================================================================

class VPFloatSideBackdrop : public VPWindowBackdrop {

public:
							VPFloatSideBackdrop();
	virtual					~VPFloatSideBackdrop();
