...
// ===========================================================================
//	VPLGAIconSuiteControl.h		© 1996-97 Metrowerks Inc. All rights reserved.
// ===========================================================================
//
//   Created: 11/15/96
//     $Date: 2006/01/18 01:34:00 $
//  $History: VPLGAIconSuiteControl.h $
//	
//	*****************  Version 3  *****************
...
// ===========================================================================
//		* VPLGAIconSuiteControl
// ===========================================================================
//	Drawing agent for the PowerPlant class LGAIconSuiteControl.

class VPLGAIconSuiteControl : public VPLControl {

public:
	static VEDrawingAgent*	CreateAgent()
								    { return new VPLGAIconSuiteControl; }
							VPLGAIconSuiteControl() {}
	virtual					~VPLGAIconSuiteControl() {}
...
// ===========================================================================
//		* VPFGAIconSuiteControl
// ===========================================================================
//	Helper class for LGAIconSuiteControl. Restricts search for graphics resources
//	to the top resource file.

class VPFGAIconSuiteControl : public LGAIconSuiteControl {

public:
							VPFGAIconSuiteControl(LStream* inStream);
	virtual					~VPFGAIconSuiteControl() { }
