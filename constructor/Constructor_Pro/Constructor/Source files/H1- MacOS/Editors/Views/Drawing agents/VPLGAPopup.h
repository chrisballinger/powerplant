...
// ===========================================================================
//	VPLGAPopup.h				© 1996-97 Metrowerks Inc. All rights reserved.
// ===========================================================================
//
//   Created: 11/15/96
//     $Date: 2006/01/18 01:34:00 $
//  $History: VPLGAPopup.h $
//	
//	*****************  Version 3  *****************
...
//		* VPLGAPopup
// ===========================================================================
//	Drawing agent for the PowerPlant class LGAPopup.

class VPLGAPopup : public VPLControl {

public:
	static VEDrawingAgent*	CreateAgent()
									{ return new VPLGAPopup; }
...
class VPFGAPopup : public LGAPopup {

public:
							VPFGAPopup(LStream* inStream);
	virtual					~VPFGAPopup();

	virtual MenuHandle		LoadPopupMenuH() const;

	friend class VPLGAPopup;
