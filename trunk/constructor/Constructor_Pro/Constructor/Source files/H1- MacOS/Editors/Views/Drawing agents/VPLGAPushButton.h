...
// ===========================================================================
//	VPLGAPushButton.h			© 1996-97 Metrowerks Inc. All rights reserved.
// ===========================================================================
//
//   Created: 11/15/96
//     $Date: 2006/01/18 01:34:00 $
//  $History: VPLGAPushButton.h $
//	
//	*****************  Version 3  *****************
...
//		* VPLGAPushButton
// ===========================================================================
//	Drawing agent for the PowerPlant class LGAPushButton.

class VPLGAPushButton : public VPLControl {

public:
	static VEDrawingAgent*	CreateAgent()
									{ return new VPLGAPushButton; }

							VPLGAPushButton() {}
	virtual					~VPLGAPushButton() {}

	virtual LPane*			CreateFromStream(LStream* inStream)
									{ return new LGAPushButton(inStream); }
