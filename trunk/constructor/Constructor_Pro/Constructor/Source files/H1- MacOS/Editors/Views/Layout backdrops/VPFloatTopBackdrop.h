...
// ===========================================================================
//	VPFloatTopBackdrop.h		© 1996-97 Metrowerks Inc. All rights reserved.
// ===========================================================================
//
//   Created: 11/18/96
//     $Date: 2006/01/18 01:34:04 $
//  $History: VPFloatTopBackdrop.h $
//	
//	*****************  Version 4  *****************
...
// ===========================================================================
//
//	VPFloatTopBackdrop draws a simulation of the standard floating
//	window WDEF.
//
// ===========================================================================

class VPFloatTopBackdrop : public VPWindowBackdrop {

public:
							VPFloatTopBackdrop();
	virtual					~VPFloatTopBackdrop();
