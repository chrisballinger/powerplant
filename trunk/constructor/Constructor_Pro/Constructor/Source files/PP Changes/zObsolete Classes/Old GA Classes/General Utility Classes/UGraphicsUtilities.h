...
public:
	...
	static	void 			PaintColorPixel 	( 	Int16			inHorizLoc,
															Int16			inVertLoc,
															RGBColor* 	inColor );
	...
	static	Int16			RectWidth				( 	Rect &inRect )
								{	return inRect.right - inRect.left; }
	static	Int16			RectHeight				(	Rect &inRect )
...
public:
	...
	static 	Int16	GetActualJustification	( Int16	inJustification )
