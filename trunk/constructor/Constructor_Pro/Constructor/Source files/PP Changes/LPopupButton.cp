...
// ===========================================================================
//	LPopupButton.cp				PowerPlant 2.2		©1997-1999 Metrowerks Inc.
// ===========================================================================
...
LPopupButton::InitPopupButton(
	ResIDT		/* inMenuID */,		// CONSTRUCTOR CHANGE
	OSType		/* inMenuResType */,	// CONSTRUCTOR CHANGE
	SInt16		inInitialMenuItem)
{
	SetMenuID(3509);			// CONSTRUCTOR CHANGE

#if 0							// CONSTRUCTOR CHANGE
	if ((mMenuH != nil) && (inMenuResType != 0)) {
		AppendResMenu(inMenuResType);	// Use Resource Type to build menu
	}
#endif							// CONSTRUCTOR CHANGE
