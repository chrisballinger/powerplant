...
// Only needs LGAIconButton.h for msg_DoubleClick
...
// CONSTRUCTOR CHANGE begin
		...
		SetMenuID(menuID);
#else
		// WB1-30508 -- Setting a bevel button's menu id to 128 would steal
		// Constructor's File menu.
		SetMenuID(3509); // Use the "GAPopup helper menu" like LPopupButton does.
#endif
...
LBevelButton::SetMenuMinMax()
{
	...
	if ( GetMacMenuH() != nil ) {
		numMenuItems = ::CountMenuItems( GetMacMenuH() );
	}
